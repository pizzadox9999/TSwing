...
public class TDragSourceDragEvent extends TDragSourceEvent {
    ...
    public TDragSourceDragEvent(TDragSourceContext dsc, int dropAction, int action, int modifiers) {
        super(dsc);

        initFields(dropAction, action, modifiers);
    }

    public TDragSourceDragEvent(TDragSourceContext dsc, int dropAction, int action,
