...
public class TPageFormat implements Cloneable {
    public static final int LANDSCAPE = 0;
    public static final int PORTRAIT = 1;
    public static final int REVERSE_LANDSCAPE = 2;

    private TPaper pagePaper;
    private int   pageOrientation;

    public TPageFormat() {
        super();
        pageOrientation = PORTRAIT;
        pagePaper= new TPaper();
    }

    @Override
    public Object clone(){
        TPageFormat clonedPage;
        try {
            clonedPage = (TPageFormat) super.clone();
            clonedPage.pagePaper = (TPaper) pagePaper.clone();
