...
public abstract class TGraphicAttribute {
    ...
    protected TGraphicAttribute(int align) {
    ...
    public TGlyphJustificationInfo getJustificationInfo() {
         ...
         */
        float advance = getAdvance();
        return new TGlyphJustificationInfo(
                                    advance,
                                    false,
                                    TGlyphJustificationInfo.PRIORITY_INTERCHAR,
                                    advance / 3,
                                    advance / 3,
                                    false,
                                    TGlyphJustificationInfo.PRIORITY_WHITESPACE,
                                    0,
                                    0);
    }
