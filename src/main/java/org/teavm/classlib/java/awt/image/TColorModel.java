...
public abstract class TColorModel implements Transparency {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof TColorModel)) {
            return false;
        }
        TColorModel cm = (TColorModel) obj;
    ...
    public static TColorModel getRGBdefault() {
        if (RGBdefault == null) {
            RGBdefault = new TDirectColorModel(32, 0x00ff0000, 0x0000ff00,
    ...
    static int getTransferType(int bits) {
        if (bits <= 8) {
            ...
            return TDataBuffer.TYPE_UNDEFINED;
        }
    }
