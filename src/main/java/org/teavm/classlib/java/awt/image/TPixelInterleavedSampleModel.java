...
public class TPixelInterleavedSampleModel extends TComponentSampleModel {

    public TPixelInterleavedSampleModel(int dataType, int w, int h,
    ...
    public TSampleModel createSubsetSampleModel(int bands[]) {
        ...
        return new TPixelInterleavedSampleModel(dataType, width, height,
    ...
    public TSampleModel createCompatibleSampleModel(int w, int h) {
        ...
        return new TPixelInterleavedSampleModel(dataType, w, h, pixelStride,
