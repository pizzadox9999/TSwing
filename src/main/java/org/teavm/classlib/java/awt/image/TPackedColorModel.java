...
public abstract class TPackedColorModel extends TColorModel {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TPackedColorModel)) {
            return false;
        }
        TPackedColorModel cm = (TPackedColorModel) obj;
    ...
    public boolean isCompatibleSampleModel(TSampleModel sm) {
        ...
        if (!(sm instanceof TSinglePixelPackedSampleModel)) {
            return false;
        }
        TSinglePixelPackedSampleModel esm = (TSinglePixelPackedSampleModel) sm;
    ...
    public TSampleModel createCompatibleSampleModel(int w, int h) {
        return new TSinglePixelPackedSampleModel(transferType, w, h,
                componentMasks);
    }
    ...
    private static int validateTransferType(int transferType) {
        if (transferType != TDataBuffer.TYPE_BYTE &&
            ...
            // awt.240=The transferType not is one of TDataBuffer.TYPE_BYTE,
