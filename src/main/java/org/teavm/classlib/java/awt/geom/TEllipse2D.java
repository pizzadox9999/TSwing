...
public abstract class TEllipse2D extends TRectangularShape {

    public static class TFloat extends TEllipse2D {
    ...
    public static class TDouble extends TEllipse2D {
    ...
    class Iterator implements TPathIterator {
         ...
         */
        Iterator(TEllipse2D e, TAffineTransform t) {
            this.x = e.getX();
            this.y = e.getY();
