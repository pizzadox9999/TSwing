...
public abstract class TRectangle2D extends TRectangularShape {
    ...
    public static class TFloat extends TRectangle2D {
        ...
        public TFloat(float x, float y, float width, float height) {
        ...
        public TRectangle2D getBounds2D() {
            return new TFloat(x, y, width, height);
        }
    ...
    class Iterator implements TPathIterator {
         ...
         */
        Iterator(TRectangle2D r, TAffineTransform at) {
            this.x = r.getX();
            this.y = r.getY();
            this.width = r.getWidth();
            this.height = r.getHeight();
    ...
    public boolean intersectsLine(double x1, double y1, double x2, double y2) {
        ...
        return
            ...
            TLine2D.linesIntersect(rx1, ry1, rx2, ry2, x1, y1, x2, y2) ||
            TLine2D.linesIntersect(rx2, ry1, rx1, ry2, x1, y1, x2, y2);
    }
    ...
    public static void intersect(TRectangle2D src1, TRectangle2D src2, TRectangle2D dst) {
    ...
    public static void union(TRectangle2D src1, TRectangle2D src2, TRectangle2D dst) {
