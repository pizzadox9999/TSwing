...
public final class TDataBufferDouble extends TDataBuffer {

    double data[][];

    public TDataBufferDouble(double dataArrays[][], int size, int offsets[]) {
        super(TYPE_DOUBLE, size, dataArrays.length, offsets);
        data = dataArrays.clone();
    }

    public TDataBufferDouble(double dataArrays[][], int size) {
        super(TYPE_DOUBLE, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferDouble(double dataArray[], int size, int offset) {
