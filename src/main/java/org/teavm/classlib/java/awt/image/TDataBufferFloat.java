...
public final class TDataBufferFloat extends TDataBuffer {

    float data[][];

    public TDataBufferFloat(float dataArrays[][], int size, int offsets[]) {
        super(TYPE_FLOAT, size, dataArrays.length, offsets);
        data = dataArrays.clone();
    }

    public TDataBufferFloat(float dataArrays[][], int size) {
        super(TYPE_FLOAT, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferFloat(float dataArray[], int size, int offset) {
