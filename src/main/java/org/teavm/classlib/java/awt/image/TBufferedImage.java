...
public class TBufferedImage extends TImage implements TWritableRenderedImage, TTransparency {
    ...
    public TBufferedImage(TColorModel cm, TWritableRaster raster,
    ...
    public TBufferedImage(int width, int height, int imageType,
        ...
        case TYPE_BYTE_BINARY:
            ...
            raster = TRaster.createPackedRaster(TDataBuffer.TYPE_BYTE, width,
    ...
    public TBufferedImage(int width, int height, int imageType) {
        ...
        switch (imageType) {
        case TYPE_INT_RGB:
            cm = new TDirectColorModel(24, RED_MASK, GREEN_MASK, BLUE_MASK);
        ...
        case TYPE_BYTE_BINARY: {
            ...
            cm = new TIndexColorModel(1, 2, colorMap, 0, false, -1,
                    TDataBuffer.TYPE_BYTE);
        ...
        case TYPE_BYTE_INDEXED: {
            ...
            cm = new TIndexColorModel(8, 256, colorMap, 0, false, -1,
                    TDataBuffer.TYPE_BYTE);
            raster = TRaster.createInterleavedRaster(TDataBuffer.TYPE_BYTE,
                    width, height, 1, null);
    ...
    public TRaster getData(Rectangle rect) {
        ...
        TSampleModel nsm = sm.createCompatibleSampleModel(w, h);
        TWritableRaster outr = TRaster.createWritableRaster(nsm, 
                rect.getLocation());
        Object data = null;
    ...
    public Vector<TRenderedImage> getSources() {
        return null;
    }
    ...
    public TWritableRaster getWritableTile(int tileX, int tileY) {
        return raster;
    }
    ...
    public void removeTileObserver(TTileObserver to) {
    }

    public void addTileObserver(TTileObserver to) {
    }
    ...
    public TRaster getTile(int tileX, int tileY) {
        if (tileX == 0 && tileY == 0) {
            return raster;
        }
    ...
    public TBufferedImage getSubimage(int x, int y, int w, int h) {
        TWritableRaster wr = raster.createWritableChild(x, y, w, h, 0, 0, null);
