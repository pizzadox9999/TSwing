...
public class TRescaleOp implements TBufferedImageOp, TRasterOp {
    ...
    public TRescaleOp(float[] scaleFactors, float[] offsets, RenderingHints hints) {
    ...
    public TRescaleOp(float scaleFactor, float offset, RenderingHints hints) {
    ...
    public final TWritableRaster filter(TRaster src, TWritableRaster dst) {
        ...
        // TODO
        //if (ippFilter(src, dst, TBufferedImage.TYPE_CUSTOM, false) != 0)
    ...
    private final void createLevels(
            TSampleModel sm, int numBands, boolean skipAlpha,
