 ...
 * @author Pavel Dolgov
 */
package org.teavm.classlib.java.awt.im.spi;
...
public interface TInputMethodContext extends InputMethodRequests {
    ...
    public void enableClientWindowNotification(TInputMethod inputMethod, boolean enable);
