...
public final class TDataBufferByte extends TDataBuffer {
    ...
    public TDataBufferByte(byte dataArrays[][], int size, int offsets[]) {
        super(TYPE_BYTE, size, dataArrays.length, offsets);
        data = dataArrays.clone();
    }

    public TDataBufferByte(byte dataArrays[][], int size) {
        super(TYPE_BYTE, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferByte(byte dataArray[], int size, int offset) {
