...
public final class TDataBufferShort extends TDataBuffer {

    short data[][];

    public TDataBufferShort(short dataArrays[][], int size, int offsets[]) {
        super(TYPE_SHORT, size, dataArrays.length, offsets);
        data = dataArrays.clone();
    }

    public TDataBufferShort(short dataArrays[][], int size) {
        super(TYPE_SHORT, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferShort(short dataArray[], int size, int offset) {
