...
public final class TDataBufferUShort extends TDataBuffer {

    short data[][];

    public TDataBufferUShort(short dataArrays[][], int size, int offsets[]) {
    ...
    public TDataBufferUShort(short dataArrays[][], int size) {
        super(TYPE_USHORT, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferUShort(short dataArray[], int size, int offset) {
