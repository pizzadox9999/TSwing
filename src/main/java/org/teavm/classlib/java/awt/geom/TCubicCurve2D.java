...
public abstract class TCubicCurve2D implements TShape, Cloneable {

    public static class TFloat extends TCubicCurve2D {
        ...
        public TFloat(float x1, float y1, float ctrlx1, float ctrly1, float ctrlx2, float ctrly2, float x2, float y2) {
        ...
        @Override
        public TPoint2D getCtrlP1() {
            return new TPoint2D.TFloat(ctrlx1, ctrly1);
        }

        @Override
        public TPoint2D getCtrlP2() {
            return new TPoint2D.TFloat(ctrlx2, ctrly2);
        }
        ...
        public TRectangle2D getBounds2D() {
            ...
            return new TRectangle2D.TFloat(rx1, ry1, rx2 - rx1, ry2 - ry1);
        }
    }

    public static class TDouble extends TCubicCurve2D {
        ...
        public TDouble(double x1, double y1, double ctrlx1, double ctrly1,
                double ctrlx2, double ctrly2, double x2, double y2) {
            setCurve(x1, y1, ctrlx1, ctrly1, ctrlx2, ctrly2, x2, y2);
        }
        ...
        @Override
        public TPoint2D getCtrlP1() {
            return new TPoint2D.TDouble(ctrlx1, ctrly1);
        }

        @Override
        public TPoint2D getCtrlP2() {
            return new TPoint2D.TDouble(ctrlx2, ctrly2);
        }
    ...
    class Iterator implements TPathIterator {
         ...
         */
        Iterator(TCubicCurve2D c, TAffineTransform t) {
            this.c = c;
            this.t = t;
        }
    ...
    public abstract TPoint2D getCtrlP1();

    public abstract double getCtrlX2();

    public abstract double getCtrlY2();

    public abstract TPoint2D getCtrlP2();
    ...
    public void setCurve(TPoint2D p1, TPoint2D cp1, TPoint2D cp2, TPoint2D p2) {
        setCurve(
                p1.getX(), p1.getY(),
                cp1.getX(), cp1.getY(),
                cp2.getX(), cp2.getY(),
    ...
    public void setCurve(TCubicCurve2D curve) {
        setCurve(
    ...
    {
        return Math.max(
                TLine2D.ptSegDistSq(x1, y1, x2, y2, ctrlx1, ctrly1),
                TLine2D.ptSegDistSq(x1, y1, x2, y2, ctrlx2, ctrly2));
    }
    ...
    public void subdivide(TCubicCurve2D left, TCubicCurve2D right) {
        subdivide(this, left, right);
    }

    public static void subdivide(TCubicCurve2D src, TCubicCurve2D left, TCubicCurve2D right) {
        double x1 = src.getX1();
        double y1 = src.getY1();
    ...
    public TPathIterator getPathIterator(TAffineTransform at, double flatness) {
        return new TFlatteningPathIterator(getPathIterator(at), flatness);
    }
