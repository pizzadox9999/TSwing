...
public abstract class TLine2D implements TShape, Cloneable {
    ...
    public static class TFloat extends TLine2D {
        ...
        public TFloat(float x1, float y1, float x2, float y2) {
            setLine(x1, y1, x2, y2);
        }

        public TFloat(TPoint2D p1, TPoint2D p2) {
            setLine(p1, p2);
        }
        ...
        public TRectangle2D getBounds2D() {
            ...
            return new TRectangle2D.TFloat(rx, ry, rw, rh);
        }
    }
    ...
    public static class Double extends TLine2D {
        ...
        public Double(TPoint2D p1, TPoint2D p2) {
            setLine(p1, p2);
        }
    ...
    class Iterator implements TPathIterator {
         ...
         */
        Iterator(TLine2D l, TAffineTransform at) {
            this.x1 = l.getX1();
            this.y1 = l.getY1();
            this.x2 = l.getX2();
            this.y2 = l.getY2();
    ...
    public void setLine(TLine2D line) {
    ...
    public double ptSegDistSq(TPoint2D p) {
    ...
    public double ptSegDist(TPoint2D p) {
    ...
    public double ptLineDistSq(TPoint2D p) {
    ...
    public double ptLineDist(TPoint2D p) {
