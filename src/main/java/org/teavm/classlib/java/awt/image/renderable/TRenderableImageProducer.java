...
public class TRenderableImageProducer implements ImageProducer, Runnable {

    TRenderableImage rbl;
    TRenderContext rc;
    Vector<ImageConsumer> consumers = new Vector<ImageConsumer>();

    public TRenderableImageProducer(TRenderableImage rdblImage, TRenderContext rc) {
        this.rbl = rdblImage;
        this.rc = rc;
    }

    public synchronized void setRenderContext(TRenderContext rc) {
        this.rc = rc;
    }
