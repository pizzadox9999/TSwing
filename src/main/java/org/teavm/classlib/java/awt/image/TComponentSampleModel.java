...
public class TComponentSampleModel extends TSampleModel {
    ...
    public TComponentSampleModel(int dataType, int w, int h, int pixelStride,
    ...
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof TComponentSampleModel)) {
            return false;
        }
        TComponentSampleModel model = (TComponentSampleModel) o;
    ...
    public TSampleModel createSubsetSampleModel(int bands[]) {
        ...
        return new TComponentSampleModel(dataType, width, height, pixelStride,
    ...
    public TSampleModel createCompatibleSampleModel(int w, int h) {
        return new TComponentSampleModel(dataType, w, h, pixelStride,
    ...
    public TDataBuffer createDataBuffer() {
        ...
        case TDataBuffer.TYPE_SHORT:
            ...
            break;
        case TDataBuffer.TYPE_USHORT:
            data = new TDataBufferUShort(size, numBanks);
            break;
        case TDataBuffer.TYPE_INT:
    ...
    public final int getSampleSize(int band) {
        return TDataBuffer.getDataTypeSize(dataType);
    }

    @Override
    public final int[] getSampleSize() {
        int sampleSizes[] = new int[numBands];
        int size = TDataBuffer.getDataTypeSize(dataType);
