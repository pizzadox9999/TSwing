...
public abstract class TRoundRectangle2D extends TRectangularShape {

    public static class TFloat extends TRoundRectangle2D {
        ...
        public TFloat(float x, float y, float width, float height, float arcwidth, float archeight) {
        ...
        @Override
        public void setRoundRect(TRoundRectangle2D rr) {
        ...
        public TRectangle2D getBounds2D() {
            return new TRectangle2D.TFloat(x, y, width, height);
        }
    }

    public static class TDouble extends TRoundRectangle2D {
        ...
        public TDouble(double x, double y, double width, double height, double arcwidth, double archeight) {
            setRoundRect(x, y, width, height, arcwidth, archeight);
        }
    ...
    class Iterator implements TPathIterator {
         ...
         */
        Iterator(TRoundRectangle2D rr, TAffineTransform at) {
            this.x = rr.getX();
            this.y = rr.getY();
            this.width = rr.getWidth();
            this.height = rr.getHeight();
