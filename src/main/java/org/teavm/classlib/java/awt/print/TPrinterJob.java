...
public abstract class TPrinterJob {

    /* abstract section */
    public abstract void cancel();

    public abstract void setPrintable(TPrintable painter);

    public abstract void setPrintable(TPrintable painter, TPageFormat format);

    public abstract void setPageable(TPageable document)
            throws NullPointerException;

    public abstract void print() throws TPrinterException;
    ...
    public abstract TPageFormat pageDialog(TPageFormat page)
            throws HeadlessException;

    public abstract TPageFormat defaultPage(TPageFormat page);

    public abstract TPageFormat validatePage(TPageFormat page);

    /* static section */
    public static TPrinterJob getPrinterJob(){
         ...
         */
        return AccessController.doPrivileged(new PrivilegedAction<TPrinterJob>() {
            public TPrinterJob run() {
                ...
                try {
                    return (TPrinterJob) Class.forName(s).newInstance();
    ...
    public TPrinterJob() {
     ...
     public TPageFormat defaultPage(){
        return defaultPage(new TPageFormat());
     }
    ...
    public TPageFormat pageDialog(PrintRequestAttributeSet attributes)
        throws HeadlessException {
        //This implementation ignores the attribute set.
        if(attributes == null) {
            // awt.01='{0}' parameter is null
