...
public class TDragGestureEvent extends EventObject {

    private static final long serialVersionUID = 9080172649166731306L;

    private final TDragGestureRecognizer recognizer;
    ...
    public TDragGestureEvent(TDragGestureRecognizer dgr, int act, Point ori,
        ...
        if (!TDnDConstants.isValidAction(act)) {
    ...
    public TDragGestureRecognizer getSourceAsDragGestureRecognizer() {
        return recognizer;
    }
    ...
    public void startDrag(Cursor dragCursor, Transferable transferable)
        ...
        TDragSourceListener[] listeners = recognizer.dragSource.getDragSourceListeners();
        TDragSourceListener dsl = listeners.length > 0 ? new TDragSourceMulticaster(listeners)
                : null;
    ...
    public void startDrag(Cursor dragCursor, Transferable transferable, TDragSourceListener dsl)
            throws TInvalidDnDOperationException {
