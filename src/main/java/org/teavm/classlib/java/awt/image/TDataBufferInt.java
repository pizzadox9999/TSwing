...
public final class TDataBufferInt extends TDataBuffer {
    ...
    public TDataBufferInt(int dataArrays[][], int size, int offsets[]) {
        super(TYPE_INT, size, dataArrays.length, offsets);
        data = dataArrays.clone();
    }

    public TDataBufferInt(int dataArrays[][], int size) {
        super(TYPE_INT, size, dataArrays.length);
        data = dataArrays.clone();
    }

    public TDataBufferInt(int dataArray[], int size, int offset) {
