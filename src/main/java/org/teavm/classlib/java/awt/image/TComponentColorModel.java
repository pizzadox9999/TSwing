...
public class TComponentColorModel extends TColorModel {
    ...
    private boolean signed;   // Pixel samples are signed.
                              // Samples with TransferType TDataBuffer.TYPE_BYTE,
                              // TDataBuffer.TYPE_USHORT, TDataBuffer.TYPE_INT - 
                              // unsigned. Samples with others TransferType - 
                              // signed.

    private boolean integral; // Pixel samples are integral.
                              // Samples with TransferType TDataBuffer.TYPE_BYTE,
                              // TDataBuffer.TYPE_USHORT, TDataBuffer.Short and 
                              // TDataBuffer.TYPE_INT - integral.
    ...
    public TComponentColorModel(TColorSpace colorSpace, int bits[],
        ...
        case TDataBuffer.TYPE_DOUBLE:
            ...
            break;
        default:
            // awt.215=transferType is not one of TDataBuffer.TYPE_BYTE,
            //          TDataBuffer.TYPE_USHORT, TDataBuffer.TYPE_INT,
            //          TDataBuffer.TYPE_SHORT, TDataBuffer.TYPE_FLOAT, or
            //          TDataBuffer.TYPE_DOUBLE
    ...
    private static int[] validateBits(int bits[], TColorSpace colorSpace,
        ...
        int componentLength = TDataBuffer.getDataTypeSize(transferType);
    ...
    private static int[] createPixelBitsArray(TColorSpace colorSpace, 
        ...
        for(int i = 0; i < numComponents; i++){
            bits[i] = TDataBuffer.getDataTypeSize(transferType);
        }
        return bits;
    }
    ...
    public Object getDataElements(int components[], int offset, Object obj) {
        ...
        default:
            ...
            //          of the following transfer types: TDataBuffer.TYPE_BYTE,
            //          TDataBuffer.TYPE_USHORT, or TDataBuffer.TYPE_INT
    ...
    @Override
    public TWritableRaster getAlphaRaster(TWritableRaster raster) {
        if(!hasAlpha) {
            return null;
        }
    ...
    @Override
    public TColorModel coerceData(TWritableRaster raster,
        ...
        if (!signed) {
            return new TComponentColorModel(cs, bits, hasAlpha,
                    isAlphaPremultiplied, transparency, transferType);
        }

        return new TComponentColorModel(cs, null, hasAlpha,
                isAlphaPremultiplied, transparency, transferType);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof TComponentColorModel)) {
            return false;
        }
    ...
    public TWritableRaster createCompatibleWritableRaster(int w, int h) {
        TSampleModel sm = createCompatibleSampleModel(w, h);
        TDataBuffer db = sm.createDataBuffer();
        return TRaster.createWritableRaster(sm, db, null);
    }
    ...
    public TSampleModel createCompatibleSampleModel(int w, int h) {
        ...
        case TDataBuffer.TYPE_BYTE:
        case TDataBuffer.TYPE_USHORT:
            return new TPixelInterleavedSampleModel(transferType, w, h,
                    numComponents, w * numComponents, bandOffsets);

        default:
            return new TComponentSampleModel(transferType, w, h, numComponents,
