...
public class TDragSourceEvent extends EventObject {
    ...
    public TDragSourceEvent(TDragSourceContext dsc, int x, int y) {
        super(dsc);
    ...
    public TDragSourceContext getDragSourceContext() {
        return context;
    }
