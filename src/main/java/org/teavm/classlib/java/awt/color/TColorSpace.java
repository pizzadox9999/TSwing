...
public abstract class TColorSpace implements Serializable {
    ...
    private static TColorSpace cs_Gray = null;
    private static TColorSpace cs_PYCC = null;
    private static TColorSpace cs_CIEXYZ = null;
    private static TColorSpace cs_LRGB = null;
    private static TColorSpace cs_sRGB = null;
    ...
    public static TColorSpace getInstance(int colorspace) {
        switch (colorspace) {
            case CS_sRGB:
                if (cs_sRGB == null) {
                    cs_sRGB = new TICC_ColorSpace(
                            new TICC_ProfileStub(CS_sRGB));
            ...
            case CS_CIEXYZ:
                if (cs_CIEXYZ == null) {
                    cs_CIEXYZ = new TICC_ColorSpace(
                            new TICC_ProfileStub(CS_CIEXYZ));
                            //ICC_Profile.getInstance (CS_CIEXYZ));
                }
                return cs_CIEXYZ;
            case CS_GRAY:
                if (cs_Gray == null) {
                    cs_Gray = new TICC_ColorSpace(
                            new TICC_ProfileStub(CS_GRAY));
            ...
            case CS_PYCC:
                if (cs_PYCC == null) {
                    cs_PYCC = new TICC_ColorSpace(
                            new TICC_ProfileStub(CS_PYCC));
                            //ICC_Profile.getInstance (CS_PYCC));
                }
                return cs_PYCC;
            case CS_LINEAR_RGB:
                if (cs_LRGB == null) {
                    cs_LRGB = new TICC_ColorSpace(
                            new TICC_ProfileStub(CS_LINEAR_RGB));
                    LUTColorConverter.LINEAR_GRAY_CS = cs_Gray;
