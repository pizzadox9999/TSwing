...
public class TSinglePixelPackedSampleModel extends TSampleModel {
    ...
    public TSinglePixelPackedSampleModel(int dataType, int w, int h,
            int bitMasks[]) {
    ...
    public boolean equals(Object o) {
        if ((o == null) || !(o instanceof TSinglePixelPackedSampleModel)) {
            return false;
        }

        TSinglePixelPackedSampleModel model = (TSinglePixelPackedSampleModel) o;
    ...
    public TSampleModel createSubsetSampleModel(int bands[]) {
        ...
        return new TSinglePixelPackedSampleModel(this.dataType, this.width,
                this.height, this.scanlineStride, masks);
    }

    @Override
    public TSampleModel createCompatibleSampleModel(int w, int h) {
        return new TSinglePixelPackedSampleModel(this.dataType, w, h,
                this.bitMasks);
    }
