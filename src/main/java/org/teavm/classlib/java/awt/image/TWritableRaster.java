...
public class TWritableRaster extends TRaster {
    ...
    public TWritableRaster createWritableTranslatedChild(int childMinX,
            int childMinY) {
        return createWritableChild(minX, minY, width, height, childMinX,
                childMinY, null);
    }

    public TWritableRaster getWritableParent() {
        return (TWritableRaster) parent;
    }

    public void setRect(TRaster srcRaster) {
        setRect(0, 0, srcRaster);
    }

    public void setRect(int dx, int dy, TRaster srcRaster) {
    ...
    public void setDataElements(int x, int y, TRaster inRaster) {
