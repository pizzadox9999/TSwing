...
final class TDuplicatedPropertiesResourceBundle extends ResourceBundle {

    private final Properties properties;

    public TDuplicatedPropertiesResourceBundle(InputStream stream) throws IOException {
