...
public class LUTColorConverter {
    ...
    public static TColorSpace LINEAR_RGB_CS;

    public static TColorSpace LINEAR_GRAY_CS;

    public static TColorSpace sRGB_CS;
    ...
    public static boolean is_LINEAR_RGB_CS(TColorSpace cs) {
        return (cs == LINEAR_RGB_CS);
    }

    public static boolean is_LINEAR_GRAY_CS(TColorSpace cs) {
        return (cs == LINEAR_GRAY_CS);
    }

    public static boolean is_sRGB_CS(TColorSpace cs) {
        return (cs == sRGB_CS);
    }
