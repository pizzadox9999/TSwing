...
public class ColorConverter {
    ...
    public void translateColor(ICC_Transform t,
            TBufferedImage src, TBufferedImage dst) {
      ...
      if (srcIF != null && dstIF != null) {
        ...
        TColorModel dstCM = dst.getColorModel();
        ...
        TWritableRaster wr = src.getRaster();
     ...
     */
   public void translateColor(ICC_Transform t, TRaster src, TWritableRaster dst) {
        try{
     ...
     */
    private NativeImageFormat createImageFormat(TBufferedImage bi) {
