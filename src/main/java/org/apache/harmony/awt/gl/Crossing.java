...
//              if (R2 == Q3) {
     ...
     */
    public static int crossPath(TPathIterator p, double x, double y) {
        int cross = 0;
        double mx, my, cx, cy;
        mx = my = cx = cy = 0.0;
        ...
        while (!p.isDone()) {
            ...
            // checks if the point (x,y) is the vertex of shape with TPathIterator p           
            if (x == cx && y == cy) {
            	cross = 0;
            	cy = my;
            	break;
     ...
     */
    public static int crossShape(TShape s, double x, double y) {
     ...
     */
    public static int intersectPath(TPathIterator p, double x, double y, double w, double h) {
     ...
     */
    public static int intersectShape(TShape s, double x, double y, double w, double h) {
