...
import org.teavm.classlib.java.awt.color.TICC_Profile;
...
public class ColorScaler {
     ...
     */
    public void loadScalingData(TRaster r, TICC_Profile pf) {
        boolean isSrcTTypeIntegral =
            r.getTransferType() != TDataBuffer.TYPE_FLOAT &&
            r.getTransferType() != TDataBuffer.TYPE_DOUBLE;
     ...
     */
    public void loadScalingData(TSampleModel sm) {
        ...
        boolean isSignedShort =
            (sm.getTransferType() == TDataBuffer.TYPE_SHORT);
     ...
     */
    public void loadScalingData(TICC_Profile pf) {
     ...
     */
    public void loadScalingData(TColorSpace cs) {
     ...
     */
    public float[][] scaleNormalize(TRaster r) {
     ...
     */
    public void unscaleNormalized(TWritableRaster r, float data[][]) {
        int width = r.getWidth();
        int height = r.getHeight();
        float normMultipliers[] = new float[nColorChannels];
     ...
     */
    public void unscale(short[] data, TWritableRaster wr) {
