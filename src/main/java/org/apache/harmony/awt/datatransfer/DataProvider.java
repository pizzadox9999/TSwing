...
public interface DataProvider {
    ...
    public static final TDataFlavor urlFlavor = 
        new TDataFlavor("application/x-java-url;class=java.net.URL", "URL"); //$NON-NLS-1$ //$NON-NLS-2$
    
    public static final TDataFlavor uriFlavor = 
        new TDataFlavor("text/uri-list", "URI"); //$NON-NLS-1$ //$NON-NLS-2$
